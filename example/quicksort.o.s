...
void push_a(filo_t* f)
{
  ...
  f->a_top++;
  10:	00852783          	lw	a5,8(a0)
  14:	00178793          	addi	a5,a5,1
  18:	00f52423          	sw	a5,8(a0)
  f->A[f->a_top] = f->a;
  1c:	00852703          	lw	a4,8(a0)
  20:	00271713          	slli	a4,a4,0x2
  24:	00052783          	lw	a5,0(a0)
  28:	00e787b3          	add	a5,a5,a4
  2c:	00452703          	lw	a4,4(a0)
...
void pop_a(filo_t* f)
{
  ...
  f->a = f->A[f->a_top];
  54:	00852703          	lw	a4,8(a0)
  58:	00271713          	slli	a4,a4,0x2
  5c:	00052783          	lw	a5,0(a0)
  60:	00e787b3          	add	a5,a5,a4
  64:	0007a783          	lw	a5,0(a5)
  68:	00f52223          	sw	a5,4(a0)
  f->a_top--;
  6c:	00852783          	lw	a5,8(a0)
  70:	fff78793          	addi	a5,a5,-1
  74:	00f52423          	sw	a5,8(a0)
}
