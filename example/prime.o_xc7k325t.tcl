read_verilog prime.o_xc7k325t.sv
synth_design -verilog_define XILINX= -part xc7k325t-ffg676-1 -top prime_xc7k325t 
...
write_bitstream -force prime.o_xc7k325t.bit 
write_cfgmem -format mcs -interface spix4 -size 16 -loadbit "up 0x00000000 prime.o_xc7k325t.bit" -checksum -force -file "prime.o_xc7k325t.mcs"
write_project_tcl -force prime.o_xc7k325t_vivado.tcl

open_hw
connect_hw_server
open_hw_target
set_property PROGRAM.FILE {prime.o_xc7k325t.bit} [get_hw_devices xc7k325t_0]
...
set_property PROGRAM.FILES [list "prime.o_xc7k325t.mcs" ] [ get_property PROGRAM.HW_CFGMEM [lindex [get_hw_devices xc7k325t_0] 0]]
